...
The way I picked which thing to go to, was purely based on title.
...
Peter Joosten talked about his life as a human labrat, all the different things he's been trying out on himself.
...
He explained there are so many ways to measure everything about your body nowadays. For example you can send your poop to [ubiome](http://ubiome.com/); find out what your DNA can do for you with [23andme](https://www.23andme.com/en-gb/)
...
By far the most interesting talk of the first day was about _Pulling in the same direction with autonomous teams_
...
Here’s the github repo that used Ethereum (or more specifically Truffle) to build a so called _Dapp_ (decentralized app): https://github.com/djbart/Kudos.
...
Here's mine.
[![]({{site.url}}/public/assets/2016-09-11-darefest-2016/personal-context-map.jpg)]({{site.url}}/public/assets/2016-09-11-darefest-2016/personal-context-map.jpg)
...
After _event x_ happened. The _Goals_ card is the baseline.
...
I also met all three Bol.com Agile Coaches, helping 32 teams in Amersfoort.
...
They have been researching for 3 years alongside the university of Ghent, which culminated in to some kind of framework on how to instill creativity in all layers of your company.
...
### Deepak
[Deepak Mehra](@deeeep) made me chuckle when he ranted on Plastische Opvoeding in belgian schools: teaching kids important, artistic skills in 1 hour a week, which is perceived as _relax-time without guidance_, by the teacher that is the least motivated in the entire school. I had to chuckle.

Deepak Mehta (@deeeep) then gave a talk about Education in the Exponential Age.
With _Exponential Age_ he is referring to the theory behind The Singularity (computer power is growing exponentially and will eventually outperform human brainpower).
...
As a solution (in the field of education), he thinks that we should teach kids how to Learn - Unlearn - Relearn (Toffler). (Read this: http://www.forbes.com/sites/margiewarrell/2014/02/03/learn-unlearn-and-relearn/#ae2dda451c87)
...
We should also teach our kids `Design Thinking`. (http://blog.antwerpmanagementschool.be/en/design-thinking-is-dead)
And have them do peer2peer learning. Because learning from another kid increases relatedness, and teaching provides new and better insights. The role of an actual teacher would move more towards a coach and mentor instead of a _know-it-all_ type of person.
...
### BioComputer
Just saw an interesting talk about a designer that made an art installation called BioComputer, that serves as a sort of assessment of future speculative technology.

It fit into this: https://mitpress.mit.edu/books/speculative-everything

I already mentioned Joao Gil’s BioComputer experiment and `Speculative Everything` (https://mitpress.mit.edu/books/speculative-everything). But I wanted to repeat that, because I think it’s an easily underestimated step towards early feedback of novel ideas. Things that Startups and VC investment have to deal with every day.
...
http://www.designboom.com/design/joao-gil-biocomputer-digitalization-healthcare-07-12-2016/

### Erin Meyer
Those previous images all came from Erin Meyers workshop titled _Creating your future history: D-Day lessons for every day_

Erin Meyer has been living in belgium for half of her life. She set out to fulfill her dream of writing a book (instead of getting a Phd).
Through 3 questions out of her book D-Day lessons for every day, she taught us about ourselves.
1. What is your current version of "impossible".
_Current_, because after a while you'll have reached what seemed impossible before. _Impossible_ ==> _I'm possible_.
...
Exercise: Imagine that it's now today + 3 years. And you encounter the same people. What will you tell them about what happened to you in the past 3 years. What did you achieve? What did you experience?

To me this workshop served as a mirror. I reflected on the fact that I’m (still) not really doing anything with my life. Even in the last exercise I wrote “I still won’t know what to do with my life, but I’ve progressed in a natural way."

So it was an interesting self-reflection exercise.
The book she wrote has I believe 10 questions, but we did 3 of them.

### Driver mapping - Sociocracy 3.0
About to start a Driver Mapping workshop hosted by Jef Cumps from iLean.
Says it’s like Impact Mapping, but for organisational structure (so team drivers etc.).

### Future of good and evil
Yesterday I went to _The Future of Good and Evil_ by Dr. Stephen Cave.
He talked about what we can co when (not if) our values and morals change in the future.
...
There’s a pitfall in _believing_ in AI provided solutions though. He retold Plato's story of Socrates and Euthyphro where a son wanted to prosecute his father (who killed someone), because the Gods’ word is _good_. (http://spot.colorado.edu/~heathwoo/Phil160,Fall02/euthyphro.html)
...
Animal rights. (comparable to cannibalism)
Opening up all borders. (comparable to sexism and racism)
Don't lock people up. Help them make better choices instead.
...
Cannibalism comes down to “eating equivalent things” (things that are worth the same).

It’s something that our grandchildren might condemn us for.

As conclusion he turned his starting exercise into a positive one: _What might we be admired for?_

### Mateo Cavucci
Today I sat down across someone who happened to be a ThoughtWorks employee and I had some pretty interesting conversations with him. So far, it’s things like this that make Darefest worth it for me. The interaction with (likeminded) new people has been great. Most of the presentations themselves are too heavily _sales oriented_. It’s too clear that the speakers are there, not to share their knowledge, but rather to sell their services or product, rather than share knowledge. And that’s pretty sad.

I talked with Matteo from ThoughtWorks (Berlin) about the epic struggle with Legacy Software and applying DDD. And also about their hiring process. How they’re interested in your socio-economical perspective, and how there are *12*(!) interviews you have to take before you get hired. :slightly_smiling_face:

Looking forward to his talk tomorrow titled _As a user, I hate User Stories_.

I also went to Matteo Cavucci's (ThoughtWorks) talk on _As a User, I hate User Stories_.
Which was yet another reminder that user stories should be conversation starters, not requirements documents.
...
Basically, don’t write down the `solution space`, write down the `problem space`. (IMHO comes down to writing down the _Why?_ instead of the _What?_)
...
*Stories are not only small because these are easier to predict, but also because they're actually small experiments* (with hypotheses).
Your hypothesis must be small, right or wrong and it should serve the purpose of learning (instead of delivery or amount of delivery).
To me this is a refreshing perspective to look at stories.

A good way to move away from using Acceptance Criteria in your stories, is to come together (e.g. during kick-off or pairmodel) and to discuss what the BDD statements would be *together*.

I also wrote this down for myself: _User Stories as requirements documents are a symptom of first wave Agile._

### HTC Vive
I closed off the day by trying out Steams HTC Vive. (VR technology)
They loaded a zombie-shooter game and I got to shoot at zombies, and whack them with my combat knife.
When you first put on the goggles (they did something!), you can easily notice the outline. Like if you use your hands as goggles, you can still see the outline of your hands, it’s just like that.
But after a while you stop noticing, because you continuously immerse yourself into the 3D environment.
I think I spent about 8 minutes in the virtual, zombie infested world.
When the facilitator took off the goggles, my brain was struggling a little bit with reality. It was weird knowing that a few seconds ago, there used to be a burning appartment behind me, and a busted car to the left, some oil cans and a camp fire on the ground etc. And now they’re suddenly gone.
...
At a price of 900€, the fact that I’d still need to upgrade my desktop, and not that much content out yet, I’m going to wait for the next versions of VR hardware probably.
But it was a very fun experience.

### Conclusion
As a conclusion, the first day I was disappointed, the second day less disappointed, and the third day I felt like I actually learned a lot.
...
DareFest organisation itself had a lot of issues too. Because of the smoldering heat and lack of facilities (no airconditioning, not even ventilation) it was too hot to bear most of the time. Add to that a bunch of catering issues, complete lack of route signage, no sound isolation, no updated schedule information (e.g. I waited 10 minutes for a presentation that was cancelled; the drone racing was also cancelled, I think), and lack of information of talks (I could only base myself on presentation titles to know if it would be interesting for me).
I think this could’ve been done so much better. I also don’t understand how it could happen, since this isn’t the first time that it was organized.
Everyone I talked to said that last years event was way better, and attributed current circumstances related to presentation content to the topics being too broad.