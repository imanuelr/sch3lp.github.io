...
Deepak Mehta ([@deeeep](http://twitter.com/deeeep)) made me chuckle with his rant on Plastische Opvoeding in belgian schools: teaching kids important, artistic skills in 1 hour a week, which is perceived as _relax-time without guidance_, by the teacher that is the least motivated in the entire school. I had to chuckle.
...
And have them do peer2peer learning. Because learning from another kid increases relatedness, and teaching provides new and better insights. 
...
I think it’s an easily underestimated step towards early feedback of novel ideas. 
...
_Driver Mapping_ is a practice out of the Sociocracy 3.0 framework. It’s like _Impact Mapping_, but for organisational structure.
...
And we created so called _circles_ to tackle these categories. Overlapping tasks can be dealt with using the _delegation circle_ pattern from _Sociocracy 3.0_.
